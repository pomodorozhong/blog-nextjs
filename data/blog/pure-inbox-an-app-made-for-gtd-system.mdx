...
You can see the live roadmap at https://pure-inbox.canny.io/

<a href="https://pure-inbox.canny.io/">
  ![preview of the live roadmap](/static/images/preview-of-cannyio.png)
</a>

In the "Features" section, there are all the pending features of the app. You can let me know what features you want to see implemented first by voting there. Or in case the feature you want is not in the pending list, you can also add a feature request there.

Notice: If you want to do a vote or add a request, the website will ask you to create an account.
